        ...
        <a-form-model
            ...
            <a-form-model-item label="秘钥">
                <a-select v-model="addrForm.openId">
                    <a-select-option v-for="row in openIds" :key="row.openId" :value="row.openId">{{
                            row.useInfo
            ...
            <a-form-model-item label="访问链" prop="signUrl">
                ...
                <a-button size="small" @click="copy" id="copyBtn">
...
<script>
import {copy} from '@/components/clipboard/clipboard'
